...
func main() {
	...
	api := slack.New("xoxb-367584659222-366507826004-FWyUU8UaMVPcjBYS3p3toNQe")
	...
	for msg := range rtm.IncomingEvents {
		...
		case *slack.MessageEvent:
			...
			if strings.Contains(ev.Msg.Text, flipbotUserId) {
				...
				//for _, letter := range flipDotsWordList {
				//	if strings.Contains(ev.Msg.Text, letter) {
				//		//this will send the text to the board
				//
				//	}
				//}
			}
